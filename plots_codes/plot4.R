...
# 3.1
data_names <-  read.table("household_power_consumption.txt", sep = ";",  header = TRUE, nrows = 1)
...
# 1. Open graphics device for png (another approach is to make the plot first and save in the end)
